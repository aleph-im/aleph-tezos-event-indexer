...
#target_block_hash = sys.argv[1] # or block level
#target_op_hash = sys.argv[2]
#well_contract = 'KT1Aho6K97CKApDSCxXEzvP14qd1qTHhF4uH'
#well_contract = "KT1JPdxrbGuNpfAzvzfXJZa6Ud2qhddKmwo1"

# Test event can be found between block number 545848 and 545853 
well_contract = "KT1HWM5bNaTPvDjj1f8GxV3F6AXFj9mBFePt"

endpoint = "https://rpc.tzkt.io/ithacanet"
block_id = "head"
                ...
                if 'internal_operation_results' in tx['metadata']:
                    for internal_tx in tx['metadata']['internal_operation_results']:
                        ...
                        if internal_tx['source'] == contract:
                            print("\n\n")
                            print("\n\n")
                            print('     Sender: {}, Parameters: {}'.format(internal_tx['source'], internal_tx['parameters']))
